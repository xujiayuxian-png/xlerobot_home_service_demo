...
def generate_launch_description() -> LaunchDescription:
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('asr_backend', default_value='cpu', choices=['cpu', 'npu']),
            DeclareLaunchArgument('vlm_backend', default_value='lmstudio', choices=['lmstudio', 'npu']),
            DeclareLaunchArgument('vlm_model', default_value='qwen/qwen3-vl-4b'),
            DeclareLaunchArgument('npu_asr_url', default_value='http://127.0.0.1:18903'),
